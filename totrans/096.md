...
Scikit-learn是一个可以通过其API下载数据集的例子。相关函数定义在`sklearn.datasets`下，你可以查看函数列表：
...
![](../Images/8d0b3bd7b0346af0cb3a86092ea90bdb.png)
...
如果我们需要更多，scikit-learn提供了一个方便的函数从OpenML读取任何数据集。例如，
