...
+   [机器学习模型选择的温和介绍](a-gentle-introduction-to-model-selection-for-machine-learning.md)
...
+   [为什么机器学习每次得到的结果都不一样？](different-results-each-time-in-machine-learning.md)
...
+   [正确实现训练-验证-测试拆分和交叉验证](training-validation-test-split-and-cross-validation-done-right.md)
