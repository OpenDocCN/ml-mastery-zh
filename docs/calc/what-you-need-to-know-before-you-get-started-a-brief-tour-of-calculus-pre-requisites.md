...
![](https://machinelearningmastery.com/wp-content/uploads/2021/06/what_you_need_to_know_4.jpg)
...
当应用于直角三角形时，这三个主要函数使我们能够计算三角形的边长或其他两个锐角中的任何一个，具体取决于我们起始时所掌握的信息。特别是对于某个角度*x*，在以下 3-4-5 三角形中：
