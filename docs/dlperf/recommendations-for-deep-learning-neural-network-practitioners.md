...
[第一版](https://amzn.to/2qOitnd)于 1999 年出版，包含 17 章(每一章都由不同的学者和专家撰写)，内容是如何最大限度地利用神经网络模型。更新后的第二版增加了 13 章，其中包括由 Yoshua Bengio 撰写的一个重要章节(第十九章)，标题为“*基于梯度的深度架构培训实用建议*”
